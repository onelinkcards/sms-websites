<?php 
    $page_title = 'Faculty Staff Page Template';
    ob_start();
    ...
    <section class="rts-faculty rts-section-padding">
        <div class="container">
                    ...
                    <div class="single-staff">
                        <div class="single-staff__content">
                            ...
                            <div class="staf-info">
                                ...
                                <a href="faculty-details.php" class="rts-theme-btn border-btn">More Details</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="rts-load-more-btn rt-center mt--60">
                <a href="faculty-details.php" class="rts-theme-btn primary lh-100">Load More</a>
            </div>
        </div>
    </section>
