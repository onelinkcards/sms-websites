<?php 
    $page_title = 'Primary School Page Template';
            ...
            <div class="row g-lg-0 g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="sc__about__image">
                        <img src="assets/images/about/about_sc.webp" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="rts__section--wrapper sc__version">
                    <div class="rts__section--wrapper--left">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/about-sc.svg" alt=""> Subject 
                        </h6>
            ...
            <div class="row g-5">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single__subject bg__secondary">
                                <div class="icon">
                                    <img src="assets/images/icon/learning.svg" alt="">
                                </div>
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1">
                    <div class="subject__right__section">
                        <img src="assets/images/about/subject_sc.webp" alt="">
                    </div>
                </div>
            </div>
        </div>        
            ...
            <div class="row">
                <div class="what__we__offer__wrapper">
                    ...
                    <div class="image__section">
                        <img src="assets/images/about/what_offer.webp" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="rts__section--wrapper sc flex-md-row flex-column align-items-md-center align-items-start">
                    ...
                    <div class="rts__section--link">
                        <a href="event.php" class="rts-nbg-btn btn-arrow">Find More Professor<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                        </span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                    ...
                    <div class="rts__single--member">
                        ...
                        <div class="rts__single--member--meta">
                            <h5 class="rts__single--member--meta--title">
                                <a href="faculty-details.php">C. Hannah Ueno</a>
                            </h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rts__single--member">
                        ...
                        <div class="rts__single--member--meta">
                            <h5 class="rts__single--member--meta--title">
                                <a href="faculty-details.php">Thomas Fred</a>
                            </h5>
                            <span class="rts__single--member--meta--designation">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rts__single--member">
                        ...
                        <div class="rts__single--member--meta">
                            <h5 class="rts__single--member--meta--title">
                                <a href="faculty-details.php">Jennifer Aarons</a>
                            </h5>
                            <span class="rts__single--member--meta--designation">
                                Professor of Art
                            </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="rts__single--member">
                        ...
                        <div class="rts__single--member--meta">
                            <h5 class="rts__single--member--meta--title">
                                <a href="faculty-details.php">Michael McGarvey</a>
                            </h5>
                            <span class="rts__single--member--meta--designation">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="event__card__content">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/e-cap.svg" alt=""> Event
                        </h6>
