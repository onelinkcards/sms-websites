...
?>
                        ...
                        <div class="banner__content">
                            <div class="banner__content__top">
                                <div class="banner__content__left">
                                    <h5 class="banner__sub__heading"><img src="assets/images/icon/e-cap-small.svg" alt=""> knowledge meets innovation</h5>
                                ...
                                <div class="banner__content__right">
                                    ...
                                    <a href="program-single.php" class="rts-nbg-btn btn-arrow">View Our Program<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                                    </span></a>
                                </div>
                            </div>
    ...
    <div class="marquee">
        <div class="single__marque__item">
            <ul class="single__marque__item__list">
                <li class="single__marque__item__list__text">Anthropology <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Applied Mathematics <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Astrophysics <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Biomedical Engineering <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Arts And Humanities <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
            </ul> 
            <ul class="single__marque__item__list">
                <li class="single__marque__item__list__text">Anthropology <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Applied Mathematics <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
        ...
        <div class="single__marque__item v__2">
            <ul class="single__marque__item__list">
                <li class="single__marque__item__list__text">Architecture <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Applied Computation <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Social Sciences <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Health And Wellness <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Personal Developments <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
            </ul> 
            <ul class="single__marque__item__list">
                <li class="single__marque__item__list__text">Architecture <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
                <li class="single__marque__item__list__text">Applied Computation <span><img src="assets/images/icon/marquee__vector.svg" alt=""></span></li>
            ...
            <div class="row justify-content-sm-center justify-content-md-start align-items-center">
                <div class="col-lg-5">
                    <div class="rts__section--wrapper v__2">
                        ...
                        <a href="academic.php" class="rts-theme-btn btn-arrow">View All Program
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="program__content">
                                <div class="rts__program--item v__2" style="background-image: url(assets/images/program/program__1.jpg);">
                                    ...
                                    <a href="program-single.php" class="rts-nbg-btn btn-arrow">Learn More<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                                    </span></a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="campus__link">
                            <a href="campus-life.php" class="campus__link--btn">
                                Campus Life
                            </a>
                        </div>
                    </div>
    ...
    <div class="campus__paralax--image" style="background-image: url('assets/images/campus/paralax__image-2.jpg');">
    </div>
            ...
            <div class="row">
                <div class="rts__section--wrapper v__10">
                    ...
                    <div class="rts__section--details">
                        ...
                        <a href="research.php" class="rts-nbg-btn btn-arrow">Learn More<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                        </span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__research--single">
                        ...
                        <div class="rts__research--single--meta">
                            <a class="rts__research--single--meta--title" href="research.php">Are Social Net Work Beneficial for our Society?</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__research--single">
                        ...
                        <div class="rts__research--single--meta">
                            <a class="rts__research--single--meta--title" href="research.php">Unveiling the Frontiers Discovery and Innovation</a>
                            <p class="rts__research--single--meta--excerpt">
                                The American Journal of Applied Scientific Research (AJASR): A Rigorous Peer-Reviewed Platform.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__research--single">
                        ...
                        <div class="rts__research--single--meta">
                            <a class="rts__research--single--meta--title" href="research.php">Exploring Environmental Frontiers Unveiling Insights</a>
                            <p class="rts__research--single--meta--excerpt">
        ...
        <div class="container">
            <div class="row">
                <div class="rts__section--wrapper v__8">
                    ...
                    <div class="rts__section--link">
                        <a href="blog.php" class="rts-nbg-btn btn-arrow">View All News
            ...
            <div class="row g-5">
                <div class="col-lg-6 col-md-6">
                    <div class="blog__single--item v__2">
                        <a href="blog-details.php" class="blog__single--item--link">
                        ...
                        <div class="blog__single--item--meta">
                            ...
                            <h5 class="blog__single--item--title">
                                <a href="blog-details.php">10 from Harvard named Rhodes Scholars</a>
                            </h5>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="blog__single--item v__2">
                        ...
                        <div class="blog__single--item--meta">
                            ...
                            <h5 class="blog__single--item--title">
                                <a href="blog-details.php">Announcing the winners the 2023 Education </a>
                            </h5>
                            <p class="blog__single--item--excerpt">You'll find something to spark your
                                curiosity and enhance</p>
