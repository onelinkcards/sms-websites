<?php 
    ...
    ob_start();
    include_once 'partials/header/header-three.php';
?>
            ...
            data-swiper='{
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="banner__wrapper--bg" style="background-image: url(assets/images/banner/slider__3.jpg);">
                                <div class="container">
                        ...
                        <!-- single slides -->
                        <div class="swiper-slide">
                            <div class="banner__wrapper--bg" style="background-image: url(assets/images/banner/slider__3-2.jpg);">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6 col-md-10 col-sm-10">
                                            <div class="banner__slides--container banner__height">
            ...
            <div class="row justify-content-sm-center justify-content-lg-start">
                <div class="col-lg-6 col-xl-5 col-md-10 col-sm-11">
                    <div class="rts-left-section">
                        ...
                        <a href="about.php" class="about-btn rts-nbg-btn btn-arrow 
    ...
    <?php
    $class = 'rts-section-padding rts__light';
