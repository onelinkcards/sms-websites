    <?php 
        $page_title = 'School and College PHP Template';
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="rts-slider-height rts-slider-overlay rt-relative ">
                        <div class="rts-slider-bg" data-bgimage="url(assets/images/banner/sc-1.webp)"></div>
                        <div class="container">
                                    ...
                                    <div class="rts-slider">
                                        <div class="rts-slider-content">
                                            ...
                                            <div class="rts-slider-btn">
                                                <a href="primary-school.php" class="rts-theme-btn btn-arrow">View Our Program <span><i class="fa-thin fa-arrow-right"></i></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="swiper-slide">
                    <div class="rts-slider-height rts-slider-overlay rt-relative ">
                        <div class="rts-slider-bg" data-bgimage="url(assets/images/banner/sc-2.webp)"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 col-xl-10 col-md-10 col-sm-12">
                                    <div class="rts-slider">
                ...
                <div class="col-lg-6">
                    <div class="rts__section--wrapper sc">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/about-sc.svg" alt=""> about
                        </h6>
                        ...
                        <a href="primary-school.php" class="rts-nbg-btn btn-arrow">School Overview<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                        </span></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-12 rts-funfact sc">
                    <div class="rts-funfact-wrapper">
                        <div class="single-cta-item">
                            <img src="assets/images/icon/student.svg" alt="">
                            <h2 class="single-cta-item__title">20,000</h2>
                            <p>Students Graduated</p>
                        </div>
                        <div class="single-cta-item">
                            <img src="assets/images/icon/class.svg" alt="">
                            <h2 class="single-cta-item__title">40</h2>
                            <p>Classes</p>
                        </div>
                        <div class="single-cta-item">
                            <img src="assets/images/icon/teacher.svg" alt="">
                            <h2 class="single-cta-item__title">120</h2>
                            <p>Teachers</p>
                        </div>
                        <div class="single-cta-item">
                            <img src="assets/images/icon/current-st.svg" alt="">
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="rts__section--wrapper sc white">
                    <div class="rts__section--wrapper--left">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/e-cap.svg" alt=""> Academics 
                        </h6>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="academy__single">
                        <div class="academy__single__thumb">
                            <img src="assets/images/academy/academy-1.webp" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="academy__single">
                        <div class="academy__single__thumb">
                            <img src="assets/images/academy/academy-2.webp" alt="">
                        </div>
                        <div class="academy__single__meta">
                            <a href="#">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="academy__single">
                        <div class="academy__single__thumb">
                            <img src="assets/images/academy/academy-3.webp" alt="">
                        </div>
                        <div class="academy__single__meta">
                            <a href="#">
        ...
        <div class="container">
            <div class="row">
                <div class="rts__section--wrapper sc flex-md-row flex-wrap align-items-md-center">
                    <div class="rts__section--wrapper--left">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/about-sc.svg" alt=""> Teacher
                        </h6>
                ...
                <div class="col-sm-12">
                    <div class="rts__section--wrapper sc v2 mx-auto">
                        <h6 class="rts__section--subheading justify-content-center">
                            <img src="assets/images/icon/about-sc.svg" alt=""> Registration
                        </h6>
        ...
        <div class="container">
            <div class="row">
                <div class="rts__section--wrapper sc flex-md-row flex-wrap  align-items-md-center">
                    <div class="rts__section--wrapper--left">
                        <h6 class="rts__section--subheading">
                            <img src="assets/images/icon/about-sc.svg" alt=""> Gallery
                        </h6>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="single-gallery">
                                <a href="assets/images/campus/gallery/01.webp" class="single-gallery__item">
                                    <img src="assets/images/campus/gallery/01.webp" alt="gallery">
                        ...
                        <div class="swiper-slide">
                            <div class="single-gallery">
                                <a href="assets/images/campus/gallery/02.webp" class="single-gallery__item">
                                    <img src="assets/images/campus/gallery/02.webp" alt="gallery">
                                    <div class="single-gallery__icon">
                                        <i class="fa-light fa-circle-plus"></i>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="single-gallery">
                                <a href="assets/images/campus/gallery/03.webp" class="single-gallery__item">
                                    <img src="assets/images/campus/gallery/03.webp" alt="gallery">
                                    <div class="single-gallery__icon">
                                        <i class="fa-light fa-circle-plus"></i>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="single-gallery">
                                <a href="assets/images/campus/gallery/04.webp" class="single-gallery__item">
                                    <img src="assets/images/campus/gallery/04.webp" alt="gallery">
                                    <div class="single-gallery__icon">
                                        <i class="fa-light fa-circle-plus"></i>
                                    </div>
                                </a>
                                ...
                                <div class="rts__single--testimonial">
                                    ...
                                    <div class="rts__single--testimonial--author">
                                        ...
                                        <div class="rts__single--testimonial--quote">
                                            <img src="assets/images/testimonial/quote-3.svg" alt="quote">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- UPCOMING EVENT END -->
    <?php
    $class = 'v_1 rts-section-padding';
    include_once 'partials/components/blog-sc.php';
    ?>
