...
if (!defined('SMS_STOCK_HERO_1')) {
    define('SMS_STOCK_HERO_1', 'https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3&auto=format&fit=crop&w=2400&q=90');
}
...
if (!defined('SMS_STOCK_ABOUT_COLUMN')) {
    ...
    define('SMS_STOCK_ABOUT_COLUMN', 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=88');
}
...
if (!defined('SMS_PAGE_HERO_CONTACT')) {
    ...
    define('SMS_PAGE_HERO_CONTACT', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=88');
}
if (!defined('SMS_PAGE_HERO_ADMISSION')) {
    /* Nursing / clinical learning */
    define('SMS_PAGE_HERO_ADMISSION', 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=88');
}
if (!defined('SMS_PAGE_HERO_ABOUT')) {
    /* Students / campus life */
    define('SMS_PAGE_HERO_ABOUT', 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=88');
}
if (!defined('SMS_PAGE_HERO_GALLERY')) {
    define('SMS_PAGE_HERO_GALLERY', 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=88');
}
if (!defined('SMS_STOCK_COURSE_BSC')) {
    define('SMS_STOCK_COURSE_BSC', 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
if (!defined('SMS_STOCK_COURSE_GNM')) {
    define('SMS_STOCK_COURSE_GNM', 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
if (!defined('SMS_STOCK_CLINICAL_A')) {
    define('SMS_STOCK_CLINICAL_A', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
if (!defined('SMS_STOCK_CLINICAL_B')) {
    define('SMS_STOCK_CLINICAL_B', 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
if (!defined('SMS_STOCK_CLINICAL_C')) {
    define('SMS_STOCK_CLINICAL_C', 'https://images.unsplash.com/photo-1584515933487-779824d29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
...
if (!defined('SMS_STOCK_FAQ_SIDE')) {
    define('SMS_STOCK_FAQ_SIDE', 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=90');
}
