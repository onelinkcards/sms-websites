                ...
                <div class="campus-life">
                    <div class="campus-life__content">
                        ...
                        <div class="campus-video overflow-hidden rounded-10">
                            <img src="assets/images/campus/campus-sc.webp" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                    ...
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-1.webp" alt="item-image">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-2.webp" alt="item-image">
                            </div>
                            <div class="single-item__meta">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-3.webp" alt="item-image">
                            </div>
                            <div class="single-item__meta">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-4.webp" alt="item-image">
                            </div>
                            <div class="single-item__meta">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-5.webp" alt="item-image">
                            </div>
                            <div class="single-item__meta">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-item">
                        <div class="single-item__content">
                            <div class="single-item__image">
                                <img src="assets/images/campus/c-6.webp" alt="item-image">
                            </div>
                            <div class="single-item__meta">
