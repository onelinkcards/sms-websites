<?php 
    $page_title = 'About Us School Template';
    $body_class = 'page index-sc';
    ob_start();
    $class = 'menu__with__bg';
...
?>
        ...
        <div class="row">
            <div class="rts__section--wrapper v__4 align-items-center mx-auto text-center sc__version mb-0">
                <h6 class="rts__section--subheading justify-content-center">
                    <img src="assets/images/icon/about-sc.svg" alt=""> Programs
                </h6>
    ...
    <div class="about-page-content pb--120">
        <div class="container">
            <div class="row mb--40">
                <img src="assets/images/about/a-1.webp" alt="about" class="rounded-10">
            </div>
            <div class="row g-5">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="inline-block-element">
                        ...
                        <div class="block-element">
                            <img src="assets/images/icon/school.svg" alt="">
                            <h3>11500+</h3>
                ...
                <div class="col-lg-6">
                    <div class="mission-image">
                        <div class="centered-image">
                            <img src="assets/images/about/a-2.webp" alt="">
                        </div>
                        <div class="rotate-image">
                            <img src="assets/images/about/a-3.webp" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mission-content">
                        <div class="section-header">
                            <h6 class="rts__section--subheading">
                                <img src="assets/images/icon/about-sc.svg" alt=""> Our Mission
                            </h6>
