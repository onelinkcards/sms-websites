<?php 
    $page_title = 'University Blog Template';
    ob_start();
                            ...
                            <div class="single-blog">
                                <div class="blog single-blog__content">
                                    ...
                                    <div class="blog__meta">
                                        ...
                                        <h5 class="blog__title"> <a href="blog-details.php">Unlocking Potential: Harnessing the Transformative Power of Education for Lifelong Learning.</a></h5>
                                        <p class="excerpt">
                                        ...
                                        <a href="blog-details.php" class="rts-theme-btn primary">Read More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-blog">
                                <div class="blog single-blog__content">
                                    ...
                                    <div class="blog__meta">
                                        ...
                                        <h5 class="blog__title"> <a href="blog-details.php">Empowering Minds: Unleashing the Revolutionary Force of Education for Lifelong Growth.</a></h5>
                                        <p class="excerpt">
