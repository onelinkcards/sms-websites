...
<?php 
    $page_title = 'Program Single Template';
    ob_start();
                            ...
                            <div class="row g-5 faculty-sub-details mt--40">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-cat-item">
                                        ...
                                        <div class="cat-meta">
                                            <div class="cat-title">
                                                <a href="program-single.php">Bachelor of arts in English</a>
                                            </div>
                                            <div class="cat-link">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-cat-item">
                                        ...
                                        <div class="cat-meta">
                                            <div class="cat-title">
                                                <a href="program-single.php">M.A. English</a>
                                            </div>
                                            <div class="cat-link">
                                                <a href="program-single.php" class="cat-link-arrow"><i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                            </div>
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-11 col-lg-12">
                    <div class="rts-section rts-border-bottom-1 mb--50 pb--20">
                        ...
                        <a href="blog.php" class="rts-nbg-btn btn-arrow">View All<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                    </span></a>
                    </div>
                </div>
            </div>
