<!-- blog area start -->
<div class="rts-blog <?= htmlspecialchars($class ?? '') ?>">
    <div class="container">
                ...
                <div class="rts-blog-post blog-v-full sc__version">
                    <div class="single-blog-post">
                        <a href="blog-details.php" class="blog-thumb">
                            <img src="assets/images/blog/scb-1.webp" alt="blog-thumb">
                        </a>
            ...
            <div class="col-md-11 col-lg-6">
                <div class="rts-blog-post sc__version small__thumb">
                    ...
                    <div class="single-blog-post">
                        <div class="blog-thumb">
                            <a href="blog-details.php">
                                <img src="assets/images/blog/scb-2.webp" alt="post-thumbnail">
                            </a>
                        </div>
                        <div class="blog-content">
                    ...
                    <div class="single-blog-post">
                        <div class="blog-thumb">
                            <a href="blog-details.php">
                                <img src="assets/images/blog/scb-3.webp" alt="post-thumbnail">
                            </a>
                        </div>
                        <div class="blog-content">
