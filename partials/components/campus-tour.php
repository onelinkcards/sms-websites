<section class="rts-campus-tour <?= htmlspecialchars($class ?? '') ?>">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="rts-video-section-text rt-center mx-3">
                    ...
                    <a href="campus-life.php" class="mt--15 about-btn rts-nbg-btn btn-arrow">Visit Campus <span><i class="fa-sharp fa-regular fa-arrow-right"></i></span></a>
                </div>
            </div>
        </div>
    </div>
