<!-- header area start -->
<header class="header v__5 <?= htmlspecialchars($class ?? '') ?> header__sticky">
                ...
                <div class="header__wrapper">
                    <div class="header__logo">
                        <a href="index.php" class="header__logo--link">
                            <img src="assets/images/logo/group-21.png" alt="<?php echo htmlspecialchars(defined('SMS_SITE_NAME') ? SMS_SITE_NAME : (defined('SMS_SITE_SHORT') ? SMS_SITE_SHORT : 'Sant Manjit Singh College')); ?>" width="380" height="90" loading="eager" decoding="async">
                        </a>
                    </div>
