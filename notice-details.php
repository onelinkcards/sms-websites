<?php 
    $page_title = 'Event Details Template';
    ob_start();
...
?>
                    ...
                    <div class="rts-notice-full">
                        <div class="notice-content">
                            ...
                            <div class="notice-content__description">
                                <img src="assets/images/logo/group-21.png" alt="<?php echo htmlspecialchars(defined('SMS_SITE_SHORT') ? SMS_SITE_SHORT : 'Sant Manjit Singh College'); ?>" class="institute-logo mb--25" width="280" height="66" loading="lazy" decoding="async">
                                ...
                                <img src="assets/images/sign.png" alt="sign" class="mb--25">
                                <p>
    ...
    <?php
        ...
        $class= 'pt--100 pb--80';
        $cclass = 'v_1';
        include_once 'partials/footer/footer-one.php';
