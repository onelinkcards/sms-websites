<?php 
    $page_title = 'Lms and University Template';
    ob_start();
    include_once 'partials/header/header-two.php';
?>
        ...
        <div class="banner__wrapper">
            <div class="swiper  swiper-data"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="banner__wrapper--bg" style="background-image: url(assets/images/banner/01.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="banner__slides--container banner__height">
                                            <div class="banner__slides--content">
                                                ...
                                                <a href="program-single.php" class="rts-theme-btn btn-arrow">View Our Program
                    ...
                    <!-- single slides -->
                    <div class="swiper-slide">
                        <div class="banner__wrapper--bg" style="background-image: url(assets/images/banner/02.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="banner__slides--container banner__height">
            ...
            <div class="banner__slides--navigation">
                <div class="banner__slides--navigation--single">
                    ...
                    <a href="academic.php" class="nav__description">Browse the undergraduate
                        degrees</a>
                </div>
                <div class="banner__slides--navigation--single">
                    <h5 class="nav__title">Graduate</h5>
                    <a href="academic.php" class="nav__description">Browse the graduate degrees</a>
                </div>
            </div>
        </div>
    </div>
   ...
   <div class="rts-funfact v__2">
            ...
            <div class="row justify-content-md-center g-0">
                    ...
                    <div class="program__single--item">
                        ...
                        <ul class="program__single--item--list">
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Anthropology
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Applied Mathematics
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Biomedical Engineering
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Astrophysics
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="program__single--item v__2">
                        ...
                        <ul class="program__single--item--list">
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Applied Computation
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                            ...
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Architecture 
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="program__single--item">
                        ...
                        <ul class="program__single--item--list">
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Personal Development
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Arts and Humanities
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Health and Wellness
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li class="program__single--item--list--item">
                                <a href="program-single.php" class="link__list">Social Sciences
                                    <span><i class="fa-regular fa-arrow-right"></i></span>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="campus__single--item">
                        ...
                        <h5 class="campus__single--item--title"><a href="campus-life.php">Student Life <span><i class="fa-light fa-arrow-right"></i></span></a></h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="campus__single--item">
                        ...
                        <h5 class="campus__single--item--title"><a href="campus-life.php">Arts & Culture <span><i class="fa-light fa-arrow-right"></i></span></a></h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="campus__single--item">
                        ...
                        <h5 class="campus__single--item--title"><a href="campus-life.php">Recreation & Wellness <span><i class="fa-light fa-arrow-right"></i></span></a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-4">
                    <div class="rts__section--wrapper v__7">
                            ...
                            <a href="tution-fee.php" class="rts-theme-btn btn-arrow">Plan Details
                                <span><i class="fa-regular fa-arrow-right"></i></span>
                            </a>
                    </div>
                </div>
    ...
    <!-- tution fee end -->
    <?php
    $class = 'rts-scholarship-bg rts-section-height';
    include_once 'partials/components/scholarship.php';
    ?>
    <!-- notice board start -->
        ...
        <div class="container">
            <div class="row">
                <div class="rts__section--wrapper v__8">
                    ...
                    <div class="rts__section--link">
                        <a href="blog.php" class="rts-nbg-btn btn-arrow">View All
                            <span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                        </span></a>
                    </div>
                </div>
    ...
    <?php
        ...
        $cclass = 'v_1';
        include_once 'partials/footer/footer-v2.php';
