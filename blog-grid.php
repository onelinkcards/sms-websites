                    ...
                    <div class="single-blog">
                        <div class="blog single-blog__content">
                            ...
                            <div class="blog__meta">
                                ...
                                <h5 class="blog__title"> <a href="blog-details.php">Classroom community-building It’s ok to try
                                        something new feature! </a></h5>
                                <a href="blog-details.php" class="about-btn rts-nbg-btn btn-arrow">Read More <span><i class="fa-sharp fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
